...
export class OpenAIAdapter implements LLMAdapter {
  ...
  constructor() {
    // Support custom base URL for services like OpenRouter, Together AI, etc.
    ...
    // If base URL is provided, use it (for OpenRouter, Together AI, etc.)
    if (baseURL) {
    ...
    // Support custom model names like "openai/gpt-oss-120b" from OpenRouter
